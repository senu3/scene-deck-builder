...
**関連ファイル**: `src/components/CutCard.tsx`, `src/components/AssetPanel.tsx`, `src/store/useStore.ts`, `src/store/commands.ts`, `src/utils/assetPath.ts`, `docs/notes/export-mp4-lipsync-videoclip-plan.md`。
