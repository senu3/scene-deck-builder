...
- `docs/guides/implementation/cut-history.md` に Command 必須操作を明示。
...
受け入れ条件:
- `docs/guides/implementation/cut-history.md` と実装が一致する。
...
- `docs/guides/implementation/cut-history.md` に「禁止依存（例: slice から他 slice の内部関数直参照）」を明文化する。

## TODO
- selector 標準パターンを `docs/guides/implementation/cut-history.md` に追記する。 (完了: 2026-02-12)
